...
foreach ($all_projects as $project) {
    ...
    foreach ($hotspots as $hotspot) {
        if (in_array($post_id, $hotspot['fields']) && !in_array($project, $projects)) {
            $projects[] = $project;
        }
    }
}
...
<h3><?= __('This post presents in next projects', 'hot-projects') ?></h3>
<ul>
...
<?php else : ?>
    <p><?= __('This post doesn\'t used in any projects', 'hot-projects') ?></p>
<?php endif; ?>